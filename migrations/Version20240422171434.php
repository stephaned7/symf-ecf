 ...
 */
final class Version20240422171434 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE room_rating (id INT AUTO_INCREMENT NOT NULL, client_id INT NOT NULL, room_id INT NOT NULL, comment LONGTEXT NOT NULL, rating INT NOT NULL, posted_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_99C7E0E319EB6921 (client_id), INDEX IDX_99C7E0E354177093 (room_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
